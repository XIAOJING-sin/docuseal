...
const zh = {
  ...
  date_signed: '签署日期',
  method: '方式',
  reorder_fields: '调整字段顺序',
  verify_id: '验证身份',
  obtain_qualified_electronic_signature_with_the_trusted_provider_click_to_learn_more: '通过可信服务商获取合格电子签名（QeS）。点击了解更多。',
  editable: '可编辑',
  recurrent: '可重复',
  one_off: '一次性',
  search_field: '搜索字段',
  ...
  clear: '清除',
  align: '对齐',
  add_all_required_fields_to_continue: '请添加所有必填字段以继续',
  ...
  any: '任意',
  drawn: '手写',
  drawn_or_typed: '手写或输入',
  drawn_or_upload: '手写或上传',
  upload: '上传',
  formula: '公式',
  typed: '输入',
  ...
  draw: '绘制',
  add: '添加',
  or_add_field_without_drawing: '或无需绘制直接添加字段',
  text: '文本',
  number: '数字',
  signature: '签名',
  initials: '首字母',
  ...
  numbers_only: '仅数字',
  letters_only: '仅字母',
  regexp_validation: '正则校验',
  enter_pdf_password: '请输入 PDF 密码',
  wrong_password: '密码错误',
  currency: '货币',
  save_and_preview: '保存并预览',
  preferences: '偏好设置',
  available_in_pro: 'Pro 版可用',
  some_fields_are_missing_in_the_formula: '公式中缺少某些字段。',
  learn_more: '了解更多',
  and: '且',
  or: '或',
  start_a_quick_tour_to_learn_how_to_create_an_send_your_first_document: '开始快速导览，了解如何创建并发送你的第一个文档',
  start_tour: '开始导览'
}
