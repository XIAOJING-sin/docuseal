...
const zh = {
  ...
  must_be_characters_length: '必须为 {number} 个字符长度',
  complete_all_required_fields_to_proceed_with_identity_verification: '请填写所有必填项以继续身份验证。',
  verify_id: '验证身份',
  identity_verification: '身份验证',
  complete: '完成',
  fill_all_required_fields_to_complete: '请填写所有必填项以完成',
  sign_and_complete: '签署并完成',
  text: '文本',
  by_clicking_you_agree_to_the: '点击“{button}”即表示你同意',
  electronic_signature_disclosure: '电子签名披露',
  esignature_disclosure: '电子签名披露',
  signature: '签名',
  initials: '首字母',
  drawn_signature_on_a_touchscreen_device: '在触屏设备上绘制签名',
  approved: '已批准',
  reviewed: '已审核',
  other: '其他',
  authored_by_me: '由我发起',
  ...
  reviewed_by: '审核人',
  authored_by: '发起人',
  select_a_reason: '请选择原因',
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: '使用相机扫描二维码，在手机上打开表单并绘制签名',
  date: '日期',
  number: '数字',
  ...
  appears_on: '显示于',
  page: '页',
  select_your_option: '请选择你的选项',
  complete_hightlighted_checkboxes_and_click: '请勾选高亮的复选框并点击',
  submit: '提交',
  next: '下一步',
  click_to_upload: '点击上传',
  or_drag_and_drop_files: '或拖拽文件到此处',
  send_copy_via_email: '通过邮箱发送副本',
  download: '下载',
  clear: '清除',
  redraw: '重绘',
  draw_initials: '绘制首字母',
  ...
  document_has_been_signed: '文档已签署！',
  documents_have_been_signed: '文档已签署！',
  create_a_free_account: '创建免费账号',
  powered_by: '',
  please_check_the_box_to_continue: '请勾选复选框以继续。',
  open_source_documents_software: '',
  verified_phone_number: '验证手机号',
  use_international_format: '使用国际格式：+1xxx',
  six_digits_code: '6 位验证码',
  change_phone_number: '更换手机号',
  sending: '发送中…',
  resend_code: '重新发送验证码',
  verification_code_has_been_resent: '验证码已通过短信重新发送',
  please_fill_all_required_fields: '请填写所有必填项',
  set_today: '设为今天',
  ...
  processing: '处理中',
  pay_with_strip: '使用 Stripe 支付',
  reupload: '重新上传',
  upload: '上传',
  files: '文件',
  signature_is_too_small_or_simple_please_redraw: '签名过小或过于简单，请重新绘制。',
...
const i18n = { en, zh, es, it, de, fr, pl, uk, cs, pt, he, nl, ar, ko, ja }
